...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.args.slide_window:
            image_tensor = process_images_slid_window(image, self.image_processor, self.model_config, None, None, 336)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--patch_img_size", type=int, default=224)
    parser.add_argument("--top_p", type=float, default=None)
    parser.add_argument("--num_beams", type=int, default=1)
    parser.add_argument("--is_all_img_resize_672", type=bool, default=False)
